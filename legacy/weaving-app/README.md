...
> Archive notice: this directory is imported as historical migration material for Pulse.
> The setup and run scripts below reference old paths and download an obsolete Electron
> runtime. Do not use them as current Pulse installation instructions.
