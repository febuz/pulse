...
The record is **regenerated on `main`** (not hand-maintained), so feature PRs should
not edit ``docs/LOC_BY_LANGUAGE.md`` by hand — every PR editing the same generated
lines was a recurring merge-conflict source. Run this locally only to preview it.
...
def render(stats: dict[str, dict]) -> str:
    ...
    lines = [
        ...
        "",
        "Auto-generated by `tools/loc_report.py` and regenerated on `main` — do not",
        "edit by hand; feature PRs should not modify this file.",
        "",
